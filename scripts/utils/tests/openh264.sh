...
MOZ_GMP_PATH=./.tmp/selenium/mac/gmp-gmpopenh264/1.7.0

curl -O http://ciscobinary.openh264.org/libopenh264-1.7.0-osx64.4.dylib.bz2
bzip2 -d libopenh264-1.7.0-osx64.4.dylib.bz2
mkdir -p "${MOZ_GMP_PATH}"
mv libopenh264-1.7.0-osx64.4.dylib "${MOZ_GMP_PATH}/libgmpopenh264.dylib"
...
echo 'Version: 1.7.0' >> "${MOZ_GMP_PATH}/gmpopenh264.info"
...
echo 'user_pref("media.gmp-gmpopenh264.version", "1.7.0");' >> "./.tmp/selenium/mac/user.js"
