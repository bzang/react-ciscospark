...
import {getCurrentUser} from '@ciscospark/redux-module-users';
...
export default function constructSparkWidget(widgetName, Widget, options = {}) {
  ...
  class SparkWidget extends Component {
    ...
    componentWillReceiveProps(nextProps) {
      const {spark} = nextProps;
      const sparkState = spark.get(`status`);
      if (sparkState.get(`authenticated`) && sparkState.get(`registered`)) {
        nextProps.getCurrentUser(spark.get(`spark`));
      }
    }
