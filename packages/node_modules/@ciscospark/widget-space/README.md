# Spark Space Widget _(@ciscospark/widget-space)_
...
| Name | Data API | Req? | Description |
|:--|:-------|:-:|---|
| `accessToken` | `data-access-token` | Y | Access token for the user account initiating the messaging session. <br>For testing purposes you can use a developer access token from <https://developers.ciscospark.com>. |
